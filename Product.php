...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="Product.php" class="icon-a" style="background: #043e7d;"><i class="fa fa-medkit"></i> &nbsp;&nbsp;Product</a>
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="number" name="p_id" id="p_id">
							</td>
							                        <td>
						...
						<center>
						<button type="submit" style="background-color:#85FCA9" name=save3><b>Submit</b>
						<center>
			</fieldset>
        </form>
		</center>
