...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="NewStaff.php" class="icon-a" style="background: #043e7d;"><i class="fa fa-plus-circle  icons"></i> &nbsp;&nbsp;Add New Staff </a>
    ...
    <div id="main"   >
        ...
        <iframe src="AddStaff.html" style="width: 100%; height: 599px;" seamless="seamless" scrolling="yes" frameborder="0" allowtransparency="true" ></iframe>
