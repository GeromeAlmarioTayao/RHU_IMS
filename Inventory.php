...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="Inventory.php" class="icon-a" style="background: #043e7d;"><i class="fa fa-list icons"></i> &nbsp;&nbsp;Inventory</a>
 ...
 <center>
        ...
        <form action="add_inv.php" method="post">
            <fieldset>
				...
				<center>
                <button type="submit" style="background-color:#85FCA9" name="save2_inv"><b>Submit</b></button>
				<center>
		   </fieldset>
        </form>
    </center>
    <br>
	    ...
	    <h1>inventory</h1>
        <iframe src="display_inventory.php" style="width: 100%; height: 600px; zoom:50%;"></iframe>
    </div>
